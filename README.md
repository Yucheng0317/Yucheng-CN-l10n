...
>
> ● **查看软件介绍：方法Ⅰ-去对应吾爱破解帖子。方法Ⅱ-在[仓库Wiki](https://github.com/Yucheng0317/Yucheng-CN-l10n/wiki)中找对应软件名。**
> 
> ● **下载软件：方法Ⅰ-去对应吾爱破解帖子下载。方法Ⅱ-在仓库Code中直接找对应.apk文件。方法Ⅲ-点击标题中软件名到介绍文件中获得网盘链接（提供蓝奏云、123盘、百度云盘）下载。** Github仓库中.apk文件为安装包，.mtd文件为适用于MT管理器的该软件resources.arsc的汉化文本字典，.jpg文件为软件介绍图。
> 
> ● 下方的⏏️版本号为我汉化的对应版本，不一定为官方最新版本；🕒时间为对应版本的发帖/编辑时间。⨠代表后期更新。
>
...
[https://www.52pojie.cn/thread-1949932-1-1.html](https://www.52pojie.cn/thread-1949932-1-1.html)
  ...
  ⨠ 🕒2025.10　┃　⏏️1.6.5（汉化优化/改为Plus版包）<br>
...
🚫已停止汉化更新：已经将我的翻译版本提交官方，现软件自带官方中文翻译。
<hr>
